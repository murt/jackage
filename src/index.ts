...
export default class JKGCompiler {
    ...
    public on(event: string, callback: JKGCompilerEventHandler): JKGCompiler {
 ...
 */
export type JKGCompilerEventHandler = (event: string, compiler: JKGCompiler) => void | Promise<void>;
